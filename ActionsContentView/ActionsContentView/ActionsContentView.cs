...
namespace ActionsContentView
{
    public class ActionsContentView : ViewGroup
    {
        ...
        // .NET way
        // I ADDED THIS TO TEST OUT CUSTOM EVENTS
        // The delegate procedure we are assigning to our object
        public delegate void ContentStateChangedDelegate(ActionsContentView view, bool isContentShown);
        public delegate void ContentStateInActionDelegate(ActionsContentView view, bool isContentShowing);
        ...
        // .NEW way
        // I ADDED THESE TO TEST OUT CUSTOM EVENTS
        public event ContentStateChangedDelegate ContentStateChanged;
        public void OnContentStateChanged(ActionsContentView view, bool isContentShown)
        {
            if (ContentStateChanged != null)
            {
                ContentStateChanged(view, isContentShown);
            }
        }
        public event ContentStateInActionDelegate ContentStateInAction;
        public void OnContentStateInAction(ActionsContentView view, bool isContentShowing)
        {
            if (ContentStateInAction != null)
            {
                ContentStateInAction(view, isContentShowing);
            }
        }
        ...
        public IOnActionsContentListener OnActionsContentListener
        {
            set
            {
        ...
        private void UpdateScrollFactor()
        {
            ...
            bool isOpening = mScrollController.IsOpening;
        ...
        private class ContentScrollController : Java.Lang.Object, GestureDetector.IOnGestureListener, IRunnable
        {
            ...
            public ContentScrollController(ActionsContentView view, Scroller scroller, Scroller effectsScroller)
            {
                this.view = view;
                mScroller = scroller;
            ...
            public void Run()
            {
                ...
                if (scroller.IsFinished)
                {
                    ...
                    // .NET way
                    view.OnContentStateChanged(view, isContentShown);
                    return;
                }
